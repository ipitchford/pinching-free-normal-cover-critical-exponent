...
cryptographic manifest.  The PDF is visually checked but untagged; the Markdown
...
Public repository and archival identifiers, when
assigned, are recorded in the release metadata; their existence does not
increase the mathematical assurance level.
